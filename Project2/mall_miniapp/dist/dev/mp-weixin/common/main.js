...
var _default = {
  onLaunch: function () {
    var _onLaunch = _asyncToGenerator( /*#__PURE__*/_index.default.mark(function _callee2() {
      return _index.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              console.log('App Launch'); // 清除登陆态

              wx.setStorageSync('access_token', '');
              wx.login({
                success: function () {
                  var _success = _asyncToGenerator( /*#__PURE__*/_index.default.mark(function _callee(res) {
                    var result;
                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            ...
                            _context.next = 4;
                            return (0, _services.login)(res.code);

                          case 4:
                            result = _context.sent;
                            console.log('result:', result); // 存储登陆态
