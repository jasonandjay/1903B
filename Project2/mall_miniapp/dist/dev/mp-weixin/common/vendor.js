...
var _index = __webpack_require__(/*! ./modules/index */ 44);
...
var Fly = __webpack_require__(/*! flyio/dist/npm/wx */ 46);
...
fly.config.baseURL = "https://mall.jasonandjay.com"; //设置公共的Get参数

fly.config.params = {}; //添加请求拦截器

fly.interceptors.request.use(function (request) {
  //给所有请求添加自定义header
  request.headers["X-Tag"] = "flyio"; //打印出请求体

  console.log(request.body); //终止请求
